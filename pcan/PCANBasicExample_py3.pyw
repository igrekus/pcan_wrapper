...
from pcan.PCANBasic import *        ## PCAN-Basic library import
...
################################################################################################################################################
    ...
    def WriteFrame(self):
        ...
        print('handler', self.m_PcanHandle)
        print('msg.id', CANMsg.ID)
        print('msg.len', CANMsg.LEN)
        print('msg.msgtype', CANMsg.MSGTYPE)
        print('msg.data', CANMsg.DATA, list(CANMsg.DATA))
        # The message is sent to the configured hardware
        #
        res = self.m_objPCANBasic.Write(self.m_PcanHandle, CANMsg)
        print('result', res)
